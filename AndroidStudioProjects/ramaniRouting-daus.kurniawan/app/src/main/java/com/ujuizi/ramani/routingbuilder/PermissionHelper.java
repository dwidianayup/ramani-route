...
public class PermissionHelper {
    ...
    public void checkAndRequestPermissions(){//1. Call this to check permission. (Call this affected loop for check permission until user Approved it)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            int permissionStorage = ContextCompat.checkSelfPermission(mActivity,
                    Manifest.permission.WRITE_EXTERNAL_STORAGE);
            int locationPermission = ContextCompat.checkSelfPermission(mActivity, Manifest.permission.ACCESS_FINE_LOCATION);
            int permissionPhoneState = ContextCompat.checkSelfPermission(mActivity, Manifest.permission.READ_PHONE_STATE);
...
//                                ActivityCompat.shouldShowRequestPermissionRationale(mActivity, Manifest.permission.CAMERA) ||
                            ...
                            showDialogOK("Accessing Location, Storage, Phone State, and Camera Permissions required",
...
//                                                    break;
                        ...
                        //shouldShowRequestPermissionRationale will return false
                            ...
                            Toast.makeText(mActivity, "Go to App settings and enable permissions", Toast.LENGTH_LONG)
                                    .show();
